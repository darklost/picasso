...
class TestUtils {
  ...
  static final String URI_KEY_1 = createKey(new RequestData.Builder(URI_1).build());
  static final String URI_KEY_2 = createKey(new RequestData.Builder(URI_2).build());
  ...
  static final String FILE_KEY_1 = createKey(new RequestData.Builder(Uri.fromFile(FILE_1)).build());
  ...
  static final String CONTENT_KEY_1 = createKey(new RequestData.Builder(CONTENT_1_URL).build());
  static final Uri CONTACT_URI_1 = CONTENT_URI.buildUpon().path("1234").build();
  static final String CONTACT_KEY_1 = createKey(new RequestData.Builder(CONTACT_URI_1).build());
  static final Uri CONTACT_PHOTO_URI_1 =
      CONTENT_URI.buildUpon().path("1234").path(CONTENT_DIRECTORY).build();
  static final String CONTACT_PHOTO_KEY_1 = createKey(new RequestData.Builder(CONTACT_PHOTO_URI_1).build());
  static final int RESOURCE_ID_1 = 1;
  static final String RESOURCE_ID_KEY_1 = createKey(new RequestData.Builder(RESOURCE_ID_1).build());
